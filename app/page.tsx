...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center flex-1 w-full h-auto">
      {/* Pattern */}
      ...
      <div className="container relative z-20 flex flex-col w-full h-auto px-6 gap:6 xl:gap-10 xl:flex-row">
        {/* Left Panel */}
        <LeftPanel />
        {/* Right Panel */}
        <RightPanel />
